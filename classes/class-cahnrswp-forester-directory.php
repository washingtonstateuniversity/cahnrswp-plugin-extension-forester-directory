...
class CAHNRSWP_Forester_Directory {
	...
	public function init_plugin() {
		...
		$this->factory_service_provider = new Factory_Service_Provider();
		$this->post_type_consultant     = new Post_Type_Consultant( $this->factory_service_provider, $this->taxonomy_service, $this->taxonomy_county );
